      ...
      <Ratio ratio={size.width / size.height} className={`object-cover`} style={{ width: 100 / columnNumber + "%"  }}>
        <div className={`bg-gray-900 h-full w-full`}>
          <div className="group relative h-full z-0">
            <div className="hidden sm:flex absolute bg-black bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly z-10">
